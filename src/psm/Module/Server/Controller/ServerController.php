...
class ServerController extends AbstractServerController {
	...
	protected function executeEdit() {
		...
		if(!empty($edit_server)) {
			...
			$tpl_data = array_merge($tpl_data, array(
				...
				'edit_detectchange_selected_' . $edit_server['detectchange'] => 'selected="selected"',
	...
	protected function executeSave() {
		...
		$clean = array(
			...
			'detectchange' => in_array($_POST['detectchange'], array('yes', 'no')) ? $_POST['detectchange'] : 'no',
	...
	protected function getLabels() {
		return array(
			...
			'label_detectchange' => psm_get_lang('servers', 'detectchange'),
			'label_detectchange_description' => psm_get_lang('servers', 'detectchange_description'),
