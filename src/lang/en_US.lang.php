...
$sm_lang = array(
	...
	'servers' => array(
		...
		'detectchange' => 'Detect any change',
		'detectchange_description' => 'If this is set to Yes then the server will be marked offline when any change is detected in the HTML',
	...
	'notifications' => array(
		'off_sms' => 'ALERT Server \'%LABEL%\', ip=%IP%, port=%PORT%. Error=%ERROR%',
		'off_email_subject' => 'ALERT: Server \'%LABEL%\'',
		'off_email_body' => "ALERT:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Error: %ERROR%<br/>Date: %DATE%",
		'off_pushover_title' => 'ALERT Server \'%LABEL%\'',
		'off_pushover_message' => "ALERT:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Error: %ERROR%<br/>Date: %DATE%",
		'on_sms' => 'RECOVER Server \'%LABEL%\', ip=%IP%, port=%PORT%',
		'on_email_subject' => 'RECOVER: Server \'%LABEL%\'',
		'on_email_body' => "RECOVER:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Date: %DATE%",
		'on_pushover_title' => 'RECOVER Server \'%LABEL%\'',
		'on_pushover_message' => 'RECOVER:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Date: %DATE%',
	),
	'login' => array(
